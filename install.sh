...
link="https://raw.githubusercontent.com/BjhonStore/scriptbjhonstore/main"
# [ Warna ]
red='\e[1;31m'
green='\e[0;32m'
cyan='\e[0;36m'
...
<font color="#ffff00"><b> Admin : https://wa.link/hdi8gk</b></font><br> <font color="#0a00ff"><b>  ┗━━━━━━━━━━━━━━━━━━━━━━┛</br></font>
END
...
[Unit]
Description=UDP Request By @bjhonstore
...
clear
echo ""
echo "Kunjungi T.me/BjhonstoreSCbot "
echo "masukan kode di bawah ke bot tele di atas"
printf "7409661884:AAHLXzywcgjvnBQJlkIZBhaKrEG9b8zODYg" | telegram-send --configure
clear
